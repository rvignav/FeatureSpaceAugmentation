...
def get_cifar_dataset(trn_size=50000, tst_size=10000,
    ...
    trainset.data = trainset.data[:trn_size]
    trainset.targets = trainset.targets[:trn_size]

    testset = torchvision.datasets.CIFAR10(
        root='data/', train=False, download=True, transform=tst_transform)
    testset.data = testset.data[:tst_size]
    testset.targets = testset.targets[:tst_size]
...
def get_mnist_aug_dataset(trn_size=60000, tst_size=10000):
